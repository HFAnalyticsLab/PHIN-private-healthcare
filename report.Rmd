...
- This data is provided by [PHIN](https://www.phin.org.uk/data)
- It's still unknown whether NHS-commissioned treatments delivered by IS are counted as 'private' or 'NHS'
- It's s still unknown whether purely NHS treatments (commissioned and delivered by NHS) are in scope of the dataset
- We've reached out to PHIN team w/c 17th October
- There are concerns with data quality, with low reporting (which may not be random)
...
- Based on this data, there is no evidence that procedures where the independent sector is 'quicker' are more likely to be done privately
...
- In the past two years, specialists (in this dataset) are delivering approximately 30% of their workload in the independent sector
- But there is a lot of variation, with some specialists working almost exclusively in the independent sector
- On average, specialists haven't changed their NHS/private mix over the past two years
- There isn't evidence of certain specialties (e.g. ophthalmologists) 'switching to private' - apart from plastic surgery where the % private went up by 10 points on average
...
## Complexity: within procedures, do independent sector patients have shorter stays? 
